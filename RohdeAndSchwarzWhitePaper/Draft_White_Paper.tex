...
Transmission line or NLTL for short. We then discuss ways in which the devices
we use in simulation are modeled and the obstacles we faced in constructing
...
% Everywhere I put \blindtext should be where you type in the contents. Dont worry about formatting for now.
% Let me know if you think an image would work in a certain place and Ill add it
% Use comments like this or say something in the attached chat or slack if theres anything you think I should know
